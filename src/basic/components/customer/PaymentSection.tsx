...
export const PaymentSection = ({ totals, onCompleteOrder }: PaymentSectionProps) => {
  ...
  return (
    <section className="bg-white rounded-lg border border-gray-200 p-4">
      ...
      {/* 결제 버튼 */}
      <button onClick={onCompleteOrder} className="w-full mt-4 py-3 bg-yellow-400 text-gray-900 rounded-md font-medium hover:bg-yellow-500 transition-colors">
